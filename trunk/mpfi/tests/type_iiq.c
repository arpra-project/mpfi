/* type_iiq.c -- Test functions associated with functions of the type
                 mpfi_f (mpfi_t, mpfi_t, mpq_t).
...
void
check_line_iiq (mpfi_function_ptr this)
{
  int inex;
  ...
  mpq_ptr op2       = MPFI_FUN_ARG (*this, 4, mpq);
