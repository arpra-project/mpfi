/* type_is.c -- Test functions associated with functions of the type
                mpfi_f (mpfi_t, long).
...
void
set_prec_is (mpfi_function_ptr this, mp_prec_t prec)
{
...
clear_is (mpfi_function_ptr this)
{
  ...
  /* [3] operand (long), needs no deallocation */
...
void
mpfi_fun_init_IS (mpfi_function_ptr this, IS_fun mpfi_function,
